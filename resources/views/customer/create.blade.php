      ...
      <div id="content" class="p-4 p-md-5">
        ...
        <div class="form">
            ...
            <form action="{{ url('/customer/store') }}" method="POST">
                ...
                <label for="tambahCustomer" class="form-label" style="display: flex; flex-direction: column; align-items: center; text-align: center; font-size: large;">TAMBAH CUSTOMER</label>
                <hr>

                <div class="form-element">
                    <label class="form-label" style="display: inline-block; width: 150px;">NAMA CUSTOMER</label>
                    <input type="text" name="nama_customer" class="form-control" style="display: inline-block; width: calc(100% - 160px);" placeholder="Nama Customer" value="{{ old('nama_customer') }}">
                </div>
                
                <div class="form-element mt-3">
                    <label class="form-label" style="display: inline-block; width: 150px;">ALAMAT</label>            
                    <textarea name="alamat" class="form-control" style="display: inline-block; width: calc(100% - 160px);" placeholder="Alamat lengkap customer" rows="3">{{ old('alamat') }}</textarea>
                </div>

                <div class="form-element mt-3">
                    <label class="form-label" style="display: inline-block; width: 150px;">KONTAK</label>
                    <input type="text" name="kontak" class="form-control" style="display: inline-block; width: calc(100% - 160px);" placeholder="No. Telepon / HP" value="{{ old('kontak') }}">
                </div> 
