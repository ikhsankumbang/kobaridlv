...
if (isset($_POST['proses'])) {
  ...
  mysqli_query($conn, "UPDATE customer SET nama_customer='$nama_customer',alamat='$alamat',kontak='$kontak' WHERE id_customer='$id_customer'");
    ...
    <div id="content" class="p-4 p-md-5">
      ...
      <div class="form">
        ...
        <div class="form-element">
          ...
          <input type="text" name="id_customer" value="<?php echo $data['id_customer'] ?>" class="form-control" style="display: inline-block; width: calc(100% - 110px);" readonly>
        </div>

        <div class="form-element">
          <label class="form-label" style="display: inline-block; width: 100px;">NAMA</label>
          <input type="text" name="nama_customer" value="<?php echo $data['nama_customer'] ?>" class="form-control" placeholder="Nama Customer" style="display: inline-block; width: calc(100% - 110px);">
        </div>

        <div class="form-element">
          <label class="form-label" style="display: inline-block; width: 100px;">ALAMAT</label>
          <input type="text" name="alamat" value="<?php echo $data['alamat'] ?>" class="form-control" placeholder="alamat" style="display: inline-block; width: calc(100% - 110px);">
        </div>
        
        <div class="form-element">
          <label class="form-label" style="display: inline-block; width: 100px;">KONTAK</label>
          <input type="kontak" name="kontak" value="<?php echo $data['kontak'] ?>" class="form-control" placeholder="kontak" style="display: inline-block; width: calc(100% - 110px);">
        </div> 
        
        <div class="tombol" style="text-align: right;">
          <td><input class="btn btn-success" type="submit" name="proses" value="Ubah Customer">
            <a class="btn btn-danger" href="customer-lihat.php">kembali</a>
          </td>
        </div>
