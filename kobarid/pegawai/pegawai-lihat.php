...
<body>
  <div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 p-md-5">
      ...
      <div style="text-align: end; margin-top:-25px;"><a href="pegawai-tambah.php" class="btn btn-warning" type="button">+ TAMBAHKAN</a></div>
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td>
                  <a class="btn btn-success" href="pegawai-ubah.php?id_pegawai=<?php echo $data['id_pegawai']; ?>" role="button">Ubah</a> |
                  <a class="btn btn-danger" href="pegawai-hapus.php?id_pegawai=<?php echo $data['id_pegawai']; ?>" onclick="return confirm('yakin hapus?')">Hapus</a>
                </td>
              </tr>
            <?php } ?>
          </tbody>
