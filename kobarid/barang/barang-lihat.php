...
<body>
  ...
  <div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 p-md-5">
      ...
      <div style="text-align: end; margin-top:-25px;"><a href="barang-tambah.php" class="btn btn-warning" type="button">+ TAMBAHKAN</a></div>
      <div class="rectangle" style="width: 100%; margin-top: 5px;">
        <table id="example" class="table table-striped table-bordered" style="width:100%; text-align: center;">
          ...
          <tbody>
              ...
              ?>
            <tr>
              <td><?php echo $data['no_part']; ?></td>
              <td style="text-align: start;"><?php echo $data['nama_barang']; ?></td>
              <td><?php echo number_format($data['qty'], 0, ',', '.'); ?></td>
             <td>Rp. <?php echo number_format($data['harga'], 0, ',', '.'); ?></td>
              <td>
                <a class="btn btn-success" href="barang-ubah.php?no_part=<?php echo $data['no_part']; ?>">Ubah</a> |
                <a class="btn btn-danger" href="barang-hapus.php?no_part=<?php echo $data['no_part']; ?>" onclick="return confirm('yakin hapus?')">Hapus</a>
              </td>
            </tr>
          <?php } ?>
          </tbody>
