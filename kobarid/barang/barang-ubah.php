<?php
    include '../koneksi.php';
    $query = mysqli_query($conn, "SELECT * FROM barang WHERE no_part = '$_GET[no_part]'");
...
if (isset($_POST['proses'])){
    ...
    mysqli_query($conn, "UPDATE barang SET nama_barang='$nama_barang',qty='$qty',harga='$harga' WHERE no_part='$no_part'");
  ...
  <form action="" method="post">
      ...
      <div id="content" class="p-4 p-md-5">
        ...
        <div class="form">
            ...
            <div class="form-element">
                ...
                <input type="text" name= "no_part" value = "<?php echo $data ['no_part'] ?>" class="form-control" style="display: inline-block; width: calc(100% - 110px);" readonly>
            </div>

            <div class="form-element">
                <label class="form-label" style="display: inline-block; width: 100px;">NAMA</label>            
                <input type="text" name= "nama_barang" value = "<?php echo $data ['nama_barang'] ?>" class="form-control" style="display: inline-block; width: calc(100% - 110px);">
            </div>
            <div class="form-element">
                <label class="form-label" style="display: inline-block; width: 100px;">STOK</label>
                <input type="number" name="qty" value = "<?php echo $data ['qty'] ?>" class="form-control" style="display: inline-block; width: calc(100% - 110px);">
            </div>   
    ...
    <div style="display: inline-block; width: calc(100% - 110px);">
        <div class="input-group">
            ...
            <input type="number" name="harga" class="form-control" placeholder="10000" value="<?php echo htmlspecialchars($data['harga']); ?>">
        </div>
    </div>
</div>
            ...
            <a class="btn btn-danger" href="barang-lihat.php">kembali</a> </td>
            </div>
