  ...
  <div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 p-md-5">
      ...
      <div style="text-align: end; margin-top:-25px;">
        <a href="surat_jalan-tambah.php" class="btn btn-warning" type="button">+ TAMBAHKAN</a>
      </div>
...
?>
    <tr>
        <td><?= htmlspecialchars($data['do_no']); ?></td>
        <td><?= htmlspecialchars($data['po_no']); ?></td>
        <td><?= $tanggal; ?></td>
        <td><?= htmlspecialchars($data['prepared_name']); ?></td>
        <td><?= htmlspecialchars($data['checked_name']); ?></td>
        <td><?= htmlspecialchars($data['security_name']); ?></td>
        <td><?= htmlspecialchars($data['driver_name']); ?></td>
        <td><?= htmlspecialchars($data['received']); ?></td>
        <td><?= htmlspecialchars($data['no_kendaraan']); ?></td>
        <td>
            <a class="btn btn-success btn-sm" href="surat_jalan-ubah.php?do_no=<?= urlencode($data['do_no']); ?>">Ubah</a> |
            <a class="btn btn-danger btn-sm" href="surat_jalan-hapus.php?do_no=<?= urlencode($data['do_no']); ?>" onclick="return confirm('yakin hapus?')">Hapus</a>
        </td>
        <td>
            <a class="btn btn-secondary btn-sm" href="surat_jalan_detail-lihat.php?do_no=<?= urlencode($data['do_no']); ?>">Detail</a> |
            <a class="btn btn-primary btn-sm" href="surat_jalan-cetak.php?do_no=<?= urlencode($data['do_no']); ?>">Cetak</a>
        </td>
    </tr>
            <?php } ?>
          </tbody>
